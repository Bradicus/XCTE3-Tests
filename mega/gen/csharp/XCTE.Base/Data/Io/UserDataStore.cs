...
namespace XCTE.Base.Data.Io
{
    public class UserDataStore : IUserDataStore
    {
            ...
            try
            {
                using(SqlCommand cmd = new SqlCommand(sql, conn))
                {
                    ...
                    while(results.Read())
                    {
                        ...
                        o.Active = Convert.Toboolean(results["aActive"]);
                        o.Theme = Convert.ToString(results["aTheme"]);
        ...
        /// </summary>
        public User RetrieveOneById(long id, SqlConnection conn, SqlTransaction trans = null)
        {
            var o = new User();
